...
Current baseline: v0.6.62 BRAT Prerelease. It re-resolves same-section D&D identity from physical Markdown and normalizes only missing row section metadata before TaskMoved enqueue. Synthetic and structural checks passed; real Vault verification remains pending.
